...
<div class="modal1 fade" tabindex="-1" id="modal1Showcase">
	<div class="modal1-dialog modal1-dialog-centered modal1-dialog-scrollable modal1-fullscreen p-5">
		<div class="modal1-content rounded-4">
			<div class="modal1-header px-md-5 py-md-4 mt-2 mb-3 shadow-sm border-0">
				<h3 class="h5 fw-extrabold mb-0">Choose Layouts Dashboard</h3>
				<button type="button" class="btn-close me-1" data-bs-dismiss="modal1" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
				<path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" clip-rule="evenodd" />
			  </svg>
			  </button>
			</div>
			<div class="modal1-body px-md-5">
...
//   $("body").append(modal1Showcase);

//   const mymodal1 = new bootstrap.modal1("#modal1Showcase");
//   mymodal1.show();
// });
